  ...
  const tiers = [
    {
      ...
      tierType: 'SPONSOR',
      amount: '€ 5,000 - 9,999',
      benefits: ['Enhanced Branding', 'Events Invitations', 'Website & Social Media Visibility'],
    ...
    },
    {
      ...
      tierType: 'SPONSOR',
      amount: '€ 2,500 - 4,999',
      benefits: ['Logo in Events', 'Brand Mentions', 'Social Campaign Highlights'],
    ...
    },
    {
      ...
      tierType: 'SPONSOR',
      amount: '€ 1,000 - 2,499',
      benefits: ['Newsletter Mention', 'Logo on Website'],
