...
const StudentForm = () => {
  ...
  const interestOptions = [
    ...
    'Tech Creativity (Design/Storytelling)',
    'General Tech Literacy'
  ];

  return (
    <div className="flex flex-col items-center w-full px-4 sm:px-8 py-10">
      <h2 className="text-lg sm:text-4xl font-semibold mb-6">Prospective student</h2>
      <form
      ...
      >
        <div className="flex flex-col gap-4 w-full sm:w-1/2">
          ...
          <div>
            <label className="text-sm text-gray-600">Intended Start Period</label>
            <select
              name="startPeriod"
              ...
              className="w-full border border-black/50 rounded-lg px-4 py-2"
            >
              <option value="">Select your intended start period</option>
              <option value="2025">2025</option>
              <option value="2026">2026</option>
              <option value="2027">2027</option>
            </select>
            {errors.startPeriod && <p className="text-red-600 text-sm">{errors.startPeriod}</p>}
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 w-full sm:w-1/2">
          ...
          <div>
            <label className="text-sm text-gray-600">Preferred learning program</label>
            <select
              ...
              className="w-full border border-black/50 rounded-lg px-4 py-2"
            >
              <option value="">Select your preferred learning program</option>
              <option value="Program 1">Program 1</option>
              <option value="Program 2">Program 2</option>
              <option value="Program 3">Program 3</option>
            </select>
            {errors.preferredProgram && <p className="text-red-600 text-sm">{errors.preferredProgram}</p>}
          </div>
          <div>
            <label className="text-sm text-gray-600">What are you most interested in?</label>
