...
const CareerSection = () => {
  ...
  return (
    <div className="flex w-full max-w-[835px] h-[650px] shadow-md bg-white">
      {/* Left Column */}
      <div className="w-[304px] flex flex-col justify-between p-4 gap-2 bg-white border-r">
      ...
      {/* Right Column */}
      <div className="flex flex-col items-start bg-[#008080] text-white p-4 gap-[7px] w-full max-w-[529px] overflow-y-auto">
        {renderCareerContent()}
      </div>
    </div>
  );
