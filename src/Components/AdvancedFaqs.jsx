...
const AdvancedFaqs = () => {
  const faqs = [
    {
      question: " What should I include in my portfolio submission?",
      answer: "...................",
    },
    {
      question: " Can I apply without completing the intermediate program?",
      answer: ".........................",
    },
    {
      question: "What if my portfolio is rejected?",
      answer: "...................",
    },
    {
      question: " How soon can I start the program upon acceptance?",
      answer: ".....................",
    },
    {
      question: " Are there scholarship opportunities for the advance program?",
      answer: ".....................",
    },
    {
      question: "Can I get paid as an advance program student?",
      answer: ".....................",
    },
  ];
  ...
  return (
    <section className="w-full max-w-6xl mx-auto py-20 px-6 flex flex-col md:flex-row gap-10 md:gap-20">
      ...
      <div className="w-full md:w-2/3">
        <h2 className="text-4xl font-normal mb-6 text-black">Frequently Asked Questions</h2>
