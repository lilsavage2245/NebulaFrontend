...
const FreeClassFaqs = () => {
  const faqs = [
    ...
    {
      question: "Will this class help me decide on a tech career?",
      answer: "..............................",
    },
    {
      question: " What happens after the free class?",
      answer: "...........................",
    },
    {
  ...
  return (
    <section className="w-full max-w-6xl mx-auto py-20 px-6 flex flex-col md:flex-row gap-10 md:gap-20 mt-20">
