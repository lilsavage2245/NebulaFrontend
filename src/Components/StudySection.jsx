    ...
    <section className="w-full px-6 sm:px-12 lg:px-20 py-16 bg-white">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
        ...
        <div className="flex flex-col gap-10 max-w-xl">
          ...
          <p className="text-base sm:text-lg lg:text-[20px] leading-[32px] text-black font-poppins">
            Nebula is more than an academy. We unlock opportunities, encourage curiosity, and provide the support and tool to turn your passion into a career. Your future starts at Nebula.
          </p>

          <button className="mt-2 flex items-center gap-2 bg-[#FFC925] text-[#4A2B29] font-poppins px-6 py-2 rounded-full hover:bg-yellow-400 transition w-fit">
            Study at Nebula
            <span className="w-[18px] h-[18px] bg-black rounded-full"></span> {/* Placeholder vector */}
          </button>
        </div>
