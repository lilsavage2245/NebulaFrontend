...
export default function HeroIntermediate() {
  return (
      ...
      <div className="flex flex-col md:flex-row w-full max-w-[1500px] mx-auto min-h-[720px]">
        ...
        <div className="flex flex-col justify-start px-8 md:px-14 lg:px-20 py-10 gap-16 bg-[#008080] w-full md:w-3/5">
          <h1 className="text-white text-4xl md:text-5xl font-bold font-poppins leading-tight">
            NEBULA INTERMEDIATE PROGRAM
          </h1>
          <p className="text-white text-base md:text-lg font-poppins">
            Take your coding skill to the next level with our intermediate program at Nebula Academy. Designed for learners who already have a strong foundational understanding of coding basics, this program builds on your existing knowledge and equips you with the essential skills needed to advance your tech career, whether you have completed our beginners program or successfully passed our intermediate entry exam, you are now ready for more challenging, rewarding projects and deeper expertise. Apply today and unlock the next chapter of your coding journey.
          </p>
