// src/Pages/collaborate/components/CommunityStep.jsx
  ...
  return (
    <section className="w-full max-w-[1272px] mx-auto px-4 py-20 border-b-[5px] border-black-200">
      ...
      <div className="flex flex-col items-center gap-4 mb-12">
        ...
        <h2 className="text-[32px] sm:text-[36px] md:text-4xl lg:text-4xl font-bold text-center text-black font-poppins">
