      ...
      <div className="flex flex-col md:flex-row w-full max-w-[1500px] mx-auto min-h-[720px]">
        ...
        <div className="flex flex-col justify-start px-8 md:px-14 lg:px-20 py-10 gap-16 bg-[#008080] w-full md:w-3/5">
          <h1 className="text-white text-4xl md:text-5xl font-bold font-poppins leading-tight">
            NEBULA ADVANCED PROGRAM
          </h1>
          <p className="text-white text-base md:text-lg font-poppins">
            Elevate your expertise with the advanced program at Nebula Academy, designed specifically for experienced coders eager to master cutting- edge technologies and solve complex real-world challenges. whether you have successfully completed our intermediate program or have a robust coding port-folio show casing your advance skills, our courses provide deep, specialized knowledge that set you apart in the tech industry. Apply today and take a decisive step toward becoming a leader and innovator in your field.
          </p>
