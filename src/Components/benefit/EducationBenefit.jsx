// src/Pages/collaborate/components/EducationBenefit.jsx
...
export default function EducationBenefit() {
  const benefits = [
    {
      image: Benefit1,
    ...
    {
        image: Benefit4,
        title: "Curriculum Alignmen:",
        description:
        "Offers students professional certificate and recognitions validated by industry standard.",
    },
  ];
    ...
    <section className="w-full max-w-[1272px] mx-auto px-4 py-20">
      ...
      <div className="flex flex-col items-center gap-4 mb-12">
        ...
        <h2 className="text-[40px] font-bold text-center text-black font-poppins">
          Key Benefits Of Collaboration with Nebula Academy
        </h2>
      </div>
