// src/Components/FreeClassBenefit.jsx

import React from 'react';
import BenefitCard from './BenefitCard2';
...
export default function FreeClassBenefit() {
  return (
    <section className="w-[1512px] bg-white item-center py-8 px-2 md:px-24">
