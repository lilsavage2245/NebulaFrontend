  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-[408px] min-h-[479px]">
      ...
      <div className="flex flex-col gap-1 px-2">
        <h3 className="text-[24px] md:text-[28px] font-bold leading-[44px] text-black">
          {title}
        </h3>
        <p className="text-[16px] font-normal leading-[32px] text-black">{level}</p>
        <p className="text-[18px] font-semibold text-black">Date: {date}</p>
      </div>
